...
if __name__ == '__main__':
    ...
    scheduler_warmup = GradualWarmupScheduler(optimizer, multiplier=2, total_epoch=10, after_scheduler=scheduler_cosine)
    train_epoch=20
    for epoch in range(train_epoch):
        scheduler_warmup.step()  # 10 epoch warmup, after that schedule as scheduler_plateau
        print("epoch",epoch,"学习率为：", scheduler_warmup.get_lr())
